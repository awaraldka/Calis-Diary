...
class PostViewAdapter(val context: Context,var mArrayUri: ArrayList<String>, val click: RemoveImage):RecyclerView.Adapter<PostViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        try {
            ...
            Glide.with(context).load(listData).into(holder.binding.image)
