...
class FollowersListResponse(
    @SerializedName("result") val result : FollowersListResult,
    @SerializedName("responseMessage") val responseMessage : String,
    @SerializedName("responseCode") val responseCode : Int
)


class FollowersListResult(
    @SerializedName("docs") val docs : ArrayList<FollowersListDocs>,
...
class FollowersListDocs(
    ...
    @SerializedName("isYou") var isYou : Boolean,
