...
class FavProductsResponse(
    @SerializedName("result") val result : FavProductsResult,
    @SerializedName("responseMessage") val responseMessage : String,
    @SerializedName("responseCode") val responseCode : Int
)


class FavProductsResult(
    @SerializedName("docs") val docs : ArrayList<FavProductDocs>,
...
class FavProductDocs(
    ...
    @SerializedName("userId") val userId : FavProductUserId,
